...
export function shanghaiDayBounds(from?: string | null, to?: string | null) {
...
export function parseLedgerQuery(params: URLSearchParams) {
  ...
  return { limit, cursor: params.get("cursor") || undefined, type: type as EntryType | undefined, paymentMethod: paymentMethod as PaymentMethod | undefined, occurredAt: shanghaiDayBounds(params.get("from"), params.get("to")) };
}
